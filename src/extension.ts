...
let scrollbarHighlightDecorationType: vscode.TextEditorDecorationType;
...
export function activate(context: vscode.ExtensionContext) {
    ...
    scrollbarHighlightDecorationType = vscode.window.createTextEditorDecorationType({
        overviewRulerColor: scrollbarColor,
        overviewRulerLane: vscode.OverviewRulerLane.Center
    });
}
...
function highlightSingleOccurrenceInScrollbar(editor: vscode.TextEditor, occurrence: TextOccurrence) {
